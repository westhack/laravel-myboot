...
class ProfileController extends Controller
{
    /**
     * @OA\Post(
     *      path="/api/user/v1/account/profile", tags = {"前端-用户"}, summary="用户资料修改",
     *      @OA\Parameter(
     ...
     *      @OA\RequestBody(
     *          @OA\JsonContent(
     *              @OA\Property( property="nickname", type="string", description="昵称", example="" ),
     *              @OA\Property( property="avatar", type="string", description="头像", example="" ),
     *              @OA\Property( property="sex", type="string", description="性别", example="" ),
     *          )
     *      ),
