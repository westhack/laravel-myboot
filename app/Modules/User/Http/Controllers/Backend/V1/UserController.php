...
use App\Modules\User\Services\Form\User\UserForm;
use App\Modules\User\Services\Form\User\UserFormRequest;
...
class UserController extends Controller
{
    /**
     * @OA\Post(
     *      path="/api/backend/user/v1/user/list", tags = {"后端-用户"}, summary="用户列表",
     *      @OA\Parameter(
    ...
    public function index(Request $request)
    {
        ...
        $page = User::where('is_backend', 0)
            ->search($search)->with('roles')
            ->sortOrder($sortOrder)->paginate($limit);
    ...
    /**
     * @OA\Post(
     *      path="/api/backend/user/v1/user/create", tags = {"后端-用户"}, summary="用户添加",
     *      @OA\Parameter(
     *          in="header", name="Authorization", description="用户令牌", required=true,
     *          @OA\Schema(type="string", example="Bearer b43c5b13522193473deb3f37a3c2f50cbc5e14b6")
     *      ),
     ...
     *
     */
    public function create(UserFormRequest $request, UserForm $form)
    {
    ...
    /**
     * @OA\Post(
     *      path="/api/backend/user/v1/user/update", tags = {"后端-用户"}, summary="用户更新",
     *      @OA\Parameter(
     *          in="header", name="Authorization", description="用户令牌", required=true,
     *          @OA\Schema(type="string", example="Bearer b43c5b13522193473deb3f37a3c2f50cbc5e14b6")
     *      ),
     ...
     *
     */
    public function update(UserFormRequest $request, UserForm $form)
    {
    ...
    /**
     * @OA\Post(
     *      path="/api/backend/user/v1/user/batch/update", tags = {"后端-用户"}, summary="用户删除",
     *      @OA\Parameter(
     *          in="header", name="Authorization", description="用户令牌", required=true,
     *          @OA\Schema(type="string", example="Bearer b43c5b13522193473deb3f37a3c2f50cbc5e14b6")
     *      ),
    ...
    /**
     * @OA\Post(
     *      path="/api/backend/user/v1/user/delete", tags = {"后端-用户"}, summary="用户删除",
     *      @OA\Parameter(
     *          in="header", name="Authorization", description="用户令牌", required=true,
     *          @OA\Schema(type="string", example="Bearer b43c5b13522193473deb3f37a3c2f50cbc5e14b6")
     *      ),
